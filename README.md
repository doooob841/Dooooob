...
## 1) Download the files (important)
1. On GitHub (or wherever you received these files), click **Download ZIP**.
2. **Extract/unzip** the ZIP file.
3. Open the extracted folder and make sure you see files like:
   - `manifest.json`
   - `popup.html`
   - `popup.js`
   - `contentScript.js`
...
## 2) Install the extension (Chrome / Edge)
1. Open Chrome.
...
## 4) If something is removed by mistake
